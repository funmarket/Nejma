...
export default function VideoFeed({ 
  ...
  useEffect(() => {
    // We don't want to re-load the initial data, so we check if the tab is different from 'music'
  ...
  }, [loading, videos, artists, currentIndex, bookmarkedState, handleNext, handlePrevious, emblaRef]);
